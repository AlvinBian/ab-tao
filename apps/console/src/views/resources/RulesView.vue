...
import { useRulesStore } from "@/stores/resources";
  ...
  <div v-loading="store.loading">
    ...
    <el-card shadow="never" style="margin-bottom:16px">
      <el-row align="middle" justify="space-between">
        ...
        <el-col :span="8">
          <el-input v-model="searchQuery" placeholder="搜尋 Rule 名稱..." clearable size="small" prefix-icon="Search" />
        </el-col>
      </el-row>
    </el-card>
    ...
    <el-card shadow="never">
      ...
      <el-empty v-if="!store.loading && filteredItems.length === 0" description="無 Rule 資料" />
    </el-card>
  </div>
</template>
