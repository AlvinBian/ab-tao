---
name: ab-multi-agent-patterns
version: 1.0.0
category: workflow
description: Design multi-agent systems: supervisor pattern, swarm architecture, agent handoffs, context isolation, and parallel execution coordination.
---
