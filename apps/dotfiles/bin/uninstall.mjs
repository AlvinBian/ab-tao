...
async function main() {
  ...
  const stats = {
    ...
    agents: ALL_AGENTS.filter((a) => fs.existsSync(path.join(CLAUDE_DIR, 'agents', `${a}.md`)))
      .length,
  ...
  if (fs.existsSync(projectsDir)) {
    for (const dir of fs.readdirSync(projectsDir)) {
      ...
      if (fs.existsSync(mdPath)) {
        ...
        if (
          content.startsWith('# Generated by ab-tao') ||
          content.startsWith('# Generated by ab-dotfiles')
        )
          claudeMdCount++;
      }
    }
