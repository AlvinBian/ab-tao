...
export const RESOURCES_DIR = path.join(COMMONS_ROOT, 'resources', 'ai', 'sources');

/** ECC 資源目錄 */
export const ECC_DIR = path.join(RESOURCES_DIR, 'ecc');

/** 翻譯檔 */
export const TRANSLATIONS_PATH = path.join(COMMONS_ROOT, 'resources', 'translations.json');
